declare module "sketchmark" {
  ...
  export type NodeShape =
    ...
    | "cylinder" | "parallelogram" | "text" | "image" | "icon" | "note"
    | "line" | "path";
  ...
  export type AnimationAction =
    | "highlight" | "fade" | "unfade" | "draw" | "erase" | "show" | "hide"
    | "pulse" | "move" | "color" | "scale" | "rotate" | "narrate"
    | "circle" | "underline" | "crossout" | "bracket" | "tick" | "strikeoff";
  ...
  export type GroupChildRef =
    ...
    | { kind: "markdown"; id: string };

  export type RootItemRef = GroupChildRef;
