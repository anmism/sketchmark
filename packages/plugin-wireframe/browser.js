...
export function wireframe(options = {}) {
  return {
    name: "wireframe",
    preprocess(source) {
...
export function compileWireframe(source, options = {}) {
...
function controlLabel(command, kind) {
  ...
  if (kind === "textarea") return command.props.placeholder ?? command.props.label ?? "Write something";
  if (kind === "select") {
